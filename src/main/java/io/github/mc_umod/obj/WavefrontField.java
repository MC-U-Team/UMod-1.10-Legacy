...
public class WavefrontField {
	...
	public void addVertices(RenderBuffer buffer, ArrayList<Vec3d> vertieces, ArrayList<Vec2d> vertex_texture_cords, ArrayList<Vec3d> vertex_normals) {
		if (this.mtl.hasTexture())
			this.mtl.bindTex();
